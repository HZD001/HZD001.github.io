...
function obfuscateJS(code) {
  ...
  const protectedNames = new Set([
    ...
    'getCustomRemindersFromUI', 'saveReminder', 'removeReminder', 'updateReminder',
    'removeCustomReminder', 'updateCustomReminder', 'saveCustomReminder',
    'getReminders', 'markReminderNotified', 'isReminderNotified',
    'init', 'notify', 'showNotification', 'playSound', 'playCustomSound',
    'playBeep', 'getSoundConfig', 'flashNotification', 'notifyLunch',
    'notifyOffWork', 'notifyBreak', 'reset', 'checkCustomReminders',
    'notifyCustomReminder', 'resetCustomReminderStatus',
    ...
    'CustomReminderUI', 'enableCustomReminders', 'customRemindersSection',
    'customRemindersList', 'addReminderBtn', 'testCustomReminderBtn',
    'clearCustomRemindersBtn', 'loadReminders', 'renderReminder',
    'addNewReminder', 'removeReminder', 'testCustomReminder',
    'clearReminderStates', 'updateEnableState', 'bindEvents', 'init',
    'checkbox', 'reminder-time', 'reminder-title', 'reminder-content',
    'reminder-enabled', 'reminder-repeat', 'custom-reminder-item',
    'custom-reminder-item', 'custom-reminder-header', 'custom-reminder-title',
    'custom-reminder-actions', 'custom-reminder-fields', 'custom-reminder-field',
    'custom-reminder-checkboxes', 'custom-reminder-btn', 'custom-reminder-full-width',
    'id', 'time', 'title', 'content', 'enabled', 'repeat', 'notifiedDates',
    ...
    'text', 'lang', 'rate', 'pitch', 'volume', 'reminder', 'reminders',
    'reminderElements', 'element', 'reminderId', 'index', 'savedConfig'
  ]);
